...
## calibrate inputs
calibration_params_all <- read_csv("params/calibration_params_by_province.csv")
...
calibrate_province <- function(prov
  ...
  model_params <- fix_pars(
    read_params(paste0("params/model_params_", prov,".csv")),
  ...
  filename <- paste0("results/calibration_",end_date,"_", prov, ".RDS")
  if(all_beta){
  	filename <- paste0("results/calibration_",end_date,"_", prov, "_full.RDS")
  }
